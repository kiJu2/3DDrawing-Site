...
<html>
<head>
  <link href = "/TermProject/union/navBar/lightVer/styles.css?ver=38" rel = "stylesheet">
  <meta charset="utf-8">
  <script
  ...
  crossorigin="anonymous"></script> -->
  <script src="/TermProject/union/navBar/lightVer/script.js?ver=19"></script>
</head>
<body>
  ...
  if(isset($_SESSION['id'])){ //세션이 있냐? 로그인중이냐?
    echo '<a href="/TermProject/mypage/index.php"><img class = "loginIcon" src = "/TermProject/union/navBar/login.png"></a>';
  }
  else{
    echo '<a href="/TermProject/login/hongchong_login.php"><img class = "loginIcon" src = "/TermProject/union/navBar/login.png"></a>';
  }
   ?>
