			...
			<div id="bottom">
				<table class="tableset" align="center">
					...
					<div style="padding-bottom: 5px;">
						<input class="inputsize" type="text" name="userId"  placeholder="Enter ID" >
					</div>
					<div>
						<input class="inputsize" type="password" name="userPassword"  placeholder="Enter Password" >
					</div>
					<br>
			...
			<div id="modal">
				<div>
					<img src="/TermProject/login/image/mainlogo2.png" width="100" height="40"  >
    				 <h2>Find Your ID</h2>
   				  	<font style="color:#b2b2b2;">Enter your name and Call number. </font>
   				  	<br><br>
							<form>
